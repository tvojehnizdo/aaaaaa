...
index 64c765a93d003853071a7b5552b29bb32aff56de..b25c9bdc7c479f458abd9cc17bf257725424dbb0 100644
--- a/server.js
+++ b/server.js
@@ -1,84 +1,38 @@
- (cd "$(git rev-parse --show-toplevel)" && git apply --3way <<'EOF' 
-diff --git a/server.js b/server.js
-index 15d4e8669f6a3eb340a191c85c46fd71a0643d2a..8c88cdb745492d1e335d316a425099bbe855d4ed 100644
---- a/server.js
-+++ b/server.js
-@@ -1,42 +1,33 @@
-- (cd "$(git rev-parse --show-toplevel)" && git apply --3way <<'EOF' 
